...
function TarjetaTaller({ title, subtitle, description, image }) {
  return (
    <Card
      className="ui-card"
    ...
    >
      ...
      <CardContent sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 2 }}>
          <Box>
            <Typography variant="overline" sx={{ color: "secondary.light", fontWeight: 700, letterSpacing: 1 }}>
              Taller
            </Typography>
          ...
          <Chip label="Práctico" size="small" className="card-chip" />
        </Box>
